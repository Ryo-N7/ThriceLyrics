...
write.csv(thrice_lyrics, "~/R_materials/ThriceLyrics/thrice_webscrape.csv")

thrice_lyrics <- read.csv("~/R_materials/ThriceLyrics/thrice_webscrape.csv", 
...
One very important rule for web-scraping, especially for multiple page queries, is to include `Sys.sleep()` function so that you don't bombard the website of interest with a barrage of queries all at once!
